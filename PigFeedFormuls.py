...
def scatter_data():
    if file_name == 'สูตรพรีดิกซ์':
        ...
        for col1 in data1.columns[1:]:
            ax1.scatter(data1['น้ำหนัก'], data1[col1], label=col1)
        ax1.set_title('กราฟแสดงปริมาณสูตรพรีมิกซ์ในการเลี้ยงสุกรในแต่ละช่วงน้ำหนัก')
        ax1.set_xlabel('น้ำหนักของสุกร')
        ax1.set_ylabel('ส่วนผสมต่างๆ')
        ax1.legend()
        st.pyplot(fig1)
        ...
        for col2 in data2.columns[1:]:
            ax2.scatter(data2['น้ำหนัก'], data2[col2], label=col2)
        ax2.set_title('กราฟแสดงปริมาณสูตรผสมหัวอาหารในการเลี้ยงสุกรในแต่ละช่วงน้ำหนัก')
        ax2.set_xlabel('น้ำหนักของสุกร')
        ax2.set_ylabel('ส่วนผสมต่างๆ')
        ax2.legend()
        st.pyplot(fig2)
...
##image = Image.open('image/pig1.png')
st.subheader('สูตรพรีมิกซ์')
st.markdown("""
    มีส่วนผสมดังนี้
...
with bu2.form('my form1'):
    # st.markdown(f'สูตรอาหารที่เลือกคือ :orange[]')
...
#image = Image.open('image/pig2.png')
st.subheader('สูตรหัวอาหาร')
st.markdown("""
    มีส่วนผสมดังนี้
